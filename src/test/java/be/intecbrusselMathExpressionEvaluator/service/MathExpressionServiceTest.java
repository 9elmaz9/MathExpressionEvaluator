...
import be.intecbrussel.MathExpressionEvaluator.service.MathExpressionServiceImp;
...
public class MathExpressionServiceTest {
    ...
    {
        mathExpressionService= new MathExpressionServiceImp();
    }
    ...
    public void testExpression(String expression,String expectedResult){
        // 2 parametr nodig - expression , expected result
